...
| T09 | [手机与 PC 生产指挥台端到端](2026-08-30-openagentx-adr-001-testing/09-production-command-center-e2e.md) | T02,T04,T06,T08 | blocked（生产 API/取消闭环已确认；真实长运行 AGY 取消受 eligibility DNS 阻塞，且手机/PC 双 Session、离线浏览器证据未闭环） |
